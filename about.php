...
<section class="header">
   ...
   <nav class="navbar">
      ...
      <a href="register_form.php" class="menubar" style="background: #8E44AD; color: white; padding: 3px 8px; border-radius: 5px; font-weight: 500;">Register</a>
   </nav>
...
<section class="about">
   ...
   <div class="content">
      ...
      <h4>If you have any query fill free to call or mail us. Thank You</h4>
